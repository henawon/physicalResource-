...
var map = new ol.Map({
    ...
    layers: layersList,
    view: new ol.View({
        extent: [3219946.115277, 367674.812691, 6107288.913226, 1730522.909406], maxZoom: 28, minZoom: 1
    })
});
...
map.getView().fit([3219946.115277, 367674.812691, 6107288.913226, 1730522.909406], map.getSize());
